...
$row = 1;
if (($handle = fopen("base-industrial.csv", "r")) !== FALSE) {
             ...
             <div class="row">
                 <div class="col-lg-4">
                     <div class="service-list">
                         ...
                         <a href="gas-industrial.php?gas=oxigenio" <?= $titulo == "Oxigênio Industrial" ? "class='active'" : "" ?> >Oxigênio Industrial<span><i class="las la-arrow-right"></i></span></a>
                         <a href="gas-industrial.php?gas=acetileno" <?= $titulo == "Acetileno" ? "class='active'" : "" ?> >Acetileno<span><i class="las la-arrow-right"></i></span></a>
                         <a href="gas-industrial.php?gas=argonio" <?= $titulo == "Argônio" ? "class='active'" : "" ?> >Argônio<span><i class="las la-arrow-right"></i></span></a>
                         <a href="gas-industrial.php?gas=co2" <?= $titulo == "Dióxido de Carbono" ? "class='active'" : "" ?> >Dióxido de Carbono <span><i class="las la-arrow-right"></i></span></a>
                         <a href="gas-industrial.php?gas=helio"<?= $titulo == "Helio" ? "class='active'" : "" ?> >Helio <span><i class="las la-arrow-right"></i></span></a>
                         <a href="gas-industrial.php?gas=hidrogenio" <?= $titulo == "Hidrogênio" ? "class='active'" : "" ?> >Hidrogênio<span><i class="las la-arrow-right"></i></span></a>
                         <a href="gas-industrial.php?gas=nitrogenio" <?= $titulo == "Nitrogênio" ? "class='active'" : "" ?> >Nitrogênio<span><i class="las la-arrow-right"></i></span></a>
                         <a href="gas-industrial.php?gas=mistura-solda"<?= $titulo == "Mistura para solda" ? "class='active'" : "" ?> >Mistura para solda<span><i class="las la-arrow-right"></i></span></a>
                         <a href="gas-industrial.php?gas=gases-especiais"<?= $titulo == "Gases Especiais" ? "class='active'" : "" ?> >Gases Especiais<span><i class="las la-arrow-right"></i></span></a>
