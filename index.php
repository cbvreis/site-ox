 			...
 			<div class="row">
 				<div class="col-lg-6 col-md-12 col-sm-12">
 					<div class="contact-info">
 						<i class="las la-envelope"></i> sac@oximil.com.br |
 						<i class="las la-envelope"></i> oximil@oximil.com.br
 					</div>
 				</div>
 				<div class="col-lg-6 col-md-12 col-sm-12 text-right">
 					<div class="site-info">
 						Nós temos o ar que você precisa!
 						<div class="social-area">
 							<a href="https://www.instagram.com/oximil.gases/"><i class="lab la-instagram"></i></a>
 							<a href="https://www.linkedin.com/company/oximil-gases/?originalSubdomain=br"><i class="lab la-linkedin"></i></a>
 				    	</div>
 					</div>
 				</div>
 			</div>
 				...
 				<div class="col-lg-4 col-md-6 col-12">
 					<div class="single-project-item bg-cover project-bg">
 						<div class="project-inner">
 							<a href="single-project.html" class="project-icon">
 		...
 		<!--		<div class="col-lg-4 col-md-6 col-12">
 					<div class="single-project-item bg-cover project-bg-4">
 						<div class="project-inner">
 							...
 							<div class="hover-info">
 								<h6>Title</h6>
 								<h4>Oil & Gas Filtering</h4>
 							</div>
 						</div>
 					</div>
 				</div> 
 				<div class="col-lg-4 col-md-6 col-12">
 					<div class="single-project-item bg-cover project-bg-5">
 						<div class="project-inner">
 							<a href="single-project.html" class="project-icon">
 								<i class="las la-plus"></i>
 							</a>
 							<div class="hover-info">
 								<h6>Title</h6>
 								<h4>Flyover Construction</h4>
 							</div>
 						</div>
 					</div>
 				</div>
 				<div class="col-lg-4 col-md-6 col-12">
 					<div class="single-project-item bg-cover project-bg-6">
 						<div class="project-inner">
 							<a href="single-project.html" class="project-icon">
 								<i class="las la-plus"></i>
 							</a>
 			...
 			<div class="container">
 				<div class="row">
 					<div class="col-lg-12 text-center ">
 						<div class="section-title">
 							<h6>Testimonial</h6>
 							<h2>Happy <b> Client </b>Says <br>Sobre Nós</h2>
 						</div>
 					</div>
 				</div>
 					...
 					<div class="col-lg-12">
 						<div class="team-carousel owl-carousel">
 							<div class="single-team-item">
 								...
 								<p>There are many reseon Lorem ipsum dolor sit amet elit. Alias
 									reprehenderit</p>
 								<img src="assets/img/testimonial/1.jpg" alt="">
 								<div class="author-desc">
 									<h5>Monica Lisa</h5><span>Social Activist</span>
 								</div>
 							</div>
 							...
 							<div class="single-team-item">
 								...
 								<div class="author-desc">
 									<h5>Sarah Fatima</h5><span>Sales Officer</span>
 								</div>
 							</div>
 							...
 							<div class="single-team-item">
 								...
 								<div class="author-desc">
 									<h5>Michael Carrick</h5><span>Field Manager</span>
 								</div>
 							</div>
 						</div>
 					</div>
 			...
 			<div class="row">
 				<div class="col-lg-4 col-md-6 col-sm-12">
 					<div class="single-blog-item">
 						<div class="blog-bg">
 							<img src="assets/img/blog/blog-bg-1.jpg" alt="">
 				...
 				<div class="col-lg-4 col-md-6 col-sm-12">
 					<div class="single-blog-item">
 						<div class="blog-bg">
 							<img src="assets/img/blog/blog-bg-2.jpg" alt="">
 				...
 				<div class="col-lg-4 col-md-6 col-sm-12">
 					<div class="single-blog-item">
 						<div class="blog-bg">
 							<img src="assets/img/blog/blog-bg-3.jpg" alt="">
 		...
 		<div class="container">
 			<div class="row justify-content-center align-items-center">
 				<div class="col-lg-12 col-md-12 col-sm-12">
 					<p class="copyright-line">© 2020 Dustrian. All rights reserved | Oximil Gases LTDA.</p>
 				</div>
